...
<html>
 ...
 .background-image {
  ...
  animation: changeBackground 15s linear infinite;  /* Change toutes les 10 secondes, ajustez le temps selon vos préférences */
}

@keyframes changeBackground {
  0% { background-image: url('https://azeoo.com/app/uploads/2022/03/9-erreurs-classiques-quune-salle-de-sport-doit-eviter-1-2.jpg'); } /* Changez 'image1.jpg' avec le chemin de votre première image */
  60% { background-image: url('https://img.freepik.com/photos-gratuite/jeune-homme-bonne-sante-athlete-faisant-exercice-cordes-dans-salle-gym-modele-masculin-celibataire-pratiquant-dur-entrainant-haut-du-corps-concept-mode-vie-sain-sport-fitness-musculation-bien-etre_155003-27879.jpg'); } /* Changez 'image2.jpg' avec le chemin de votre deuxième image */
  100% { background-image: url('https://media.istockphoto.com/id/1277242852/fr/photo/tenir-le-poids-et-sasseoir.jpg?s=612x612&w=0&k=20&c=AHq87suHLg3FcYQE6Bd9MR9ZSjyeq6RVpebMLFNS2wA='); } /* Changez 'image3.jpg' avec le chemin de votre troisième image */
}
...
@media screen and (max-width:990px){.pricingTable10{margin-bottom:25px}
  ...
  <body>
    <div class="container">
       <img src="https://azeoo.com/app/uploads/2022/03/9-erreurs-classiques-quune-salle-de-sport-doit-eviter-1-2.jpg" alt="Notebook" style="width:100%; height: 80%;">
      <div class="content">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-3 col-sm-6">
                <div class="pricingTable10">
                    <div class="pricingTable-header">
                        <h3 class="heading">1 Activite</h3>
                    ...
                    <div class="pricing-content">
                        <ul>
                            <li>Acces 7j/7j 24h/24h</li>
                            <li> Club & Fitness illimité heures d'accueil</li>
                            <li>30 jours de suspension sur justificatif</li>
                            <li>seulement une activite</li>
                            <li>acces au piscine</li>
                        </ul>
            ...
            <div class="col-md-3 col-sm-6">
                <div class="pricingTable10">
                    <div class="pricingTable-header">
                        <h3 class="heading">2 Activites</h3>
                        <span class="price-value">
            ...
            <div class="col-md-3 col-sm-6">
                <div class="pricingTable10">
                    <div class="pricingTable-header">
                        <h3 class="heading">3 Activites</h3>
                        <span class="price-value">
            ...
            <div class="col-md-3 col-sm-6">
                <div class="pricingTable10">
                    <div class="pricingTable-header">
                        <h3 class="heading">4 Activites</h3>
                        <span class="price-value">
                            <span class="currency">$</span> 124
                            <span class="month">/mo</span>
                        </span>
                    </div>
                    <div class="pricing-content">
...
<BR><BR></BR></BR>
<div style="background-color: #000000; width: 350%; height: 950px; " >

  <div class="text" style="margin-left: 120%;margin-top: -650px; " >GET YOUR FREE 1-DAY PASS</div>
<form action="reservation.php" method="post">
  <input type="text" name="nom" id="nom" style="margin-left: 300px; margin-top: 170px;" placeholder="Name" >
  <input type="email" name="email" id="email" style="margin-left: 100px;" placeholder="Email">
  <br>
  <select name="campus" id="campus" style="margin-left: 300px;">
    <option >marrakechh</option>
  ...
  <input type="date" name="date" id="date" style="margin-left: 100px;" placeholder="date"><br><br>

  <input type="submit" style="margin-left: 650px;"  value="submit" name="submit" class="btn1">
  </form>
  <br><br><br><br><br><br>
